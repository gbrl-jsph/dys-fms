...
/// Light and dark color token palettes from the UI Style Guide
/// (ui-style-guide.md: Color Palette).
///
...
/// surfaces and lightened text for contrast.
class AppColors {
  AppColors._();
  ...
  /// The approved light palette (ui-style-guide.md Color Palette).
  static const Palette lightPalette = Palette(
    primary: Color(0xFF4338CA),
    primaryHover: Color(0xFF372DAA),
    primaryContainer: Color(0xFFEEEDFC),
    primaryContainerInk: Color(0xFF2E249B),
    ...
    surfaceSunken: Color(0xFFF0F1F5),
    border: Color(0xFFE4E4EA),
    borderStrong: Color(0xFFD2D3DB),
    ink: Color(0xFF1C1B22),
    inkSecondary: Color(0xFF5B5C66),
    inkMuted: Color(0xFF8B8C97),
  ...
  /// Dark-mode variant: same token names, dark surfaces and light ink so
  /// the same screens remain readable without any widget duplication.
  static const Palette darkPalette = Palette(
    primary: Color(0xFF6D62E0),
    primaryHover: Color(0xFF8A81EC),
    primaryContainer: Color(0xFF2E2A6E),
    primaryContainerInk: Color(0xFFC9C5F7),
    ...
    surfaceAlt: Color(0xFF16161B),
    surfaceSunken: Color(0xFF26262E),
    border: Color(0xFF2E2E38),
    borderStrong: Color(0xFF3A3A46),
    ink: Color(0xFFECECF1),
    inkSecondary: Color(0xFFB6B7C0),
    inkMuted: Color(0xFF8B8C97),
    inkOnPrimary: Color(0xFFFFFFFF),
