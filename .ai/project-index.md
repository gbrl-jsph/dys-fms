...
- **AI Copy**: `.ai/client-interview.md`
...
- **AI Copy**: `.ai/system-components.md`
...
- **AI Copy**: `.ai/blueprint/system-architecture.md`
...
- **AI Copy**: `.ai/blueprint/system-flowchart.md`
...
- **AI Copy**: `.ai/blueprint/user-flow.md`
...
- **AI Copy**: `.ai/blueprint/wireframes.md`
...
- **AI Copy**: `.ai/blueprint/er-diagram.md`
...
- **AI Copy**: `.ai/blueprint/database-schema.md`
...
- **AI Copy**: `.ai/blueprint/consistency-review.md`
...
- **AI Copy**: `.ai/extracted/1-system-architecture-system_architecture_documentation.md`
...
- **AI Copy**: `.ai/extracted/2-system-flowchart-dys_system_flowchart_documentation.md`
...
- **AI Copy**: `.ai/extracted/3-user-flow-diagram-dys_userflow_documentation.md`
...
- **AI Copy**: `.ai/extracted/4-use-case-diagram-use-case-diagram-documentation.md`
...
- **AI Copy**: `.ai/extracted/6-database-design-er-diagram-documentation.md`
...
- **AI Copy**: `.ai/extracted/8-research-concept-paper-revision.md`
...
- **AI Copy**: `.ai/extracted/8-research-concept-paper.md`
...
- **AI Copy**: `.ai/extracted/8-research-copy-of-interview-with-mrs-divine.md`
- **Summary**: Raw extraction of the client interview transcript.

## final.md

- **Source**: `final.html`
- **AI Copy**: `.ai/extracted/final.md`
...
- **AI Copy**: `.ai/extracted/wireframes-hifi-*.md`
